                ...
                <div className="bg-emerald-900 rounded-3xl p-6 md:p-8 text-white shadow-xl shadow-emerald-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    <button 
                      ...
                      disabled={saveLoading}
                      className="bg-white/10 hover:bg-white/20 px-6 py-2.5 rounded-2xl font-bold transition-all text-sm flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      {saveLoading ? 'Sending...' : 'Forgot Password?'}
                    </button>
                    <button 
                      onClick={() => setShowSecurityModal(true)}
                      className="bg-emerald-600 px-6 py-2.5 rounded-2xl font-bold hover:bg-emerald-700 transition-all text-sm shadow-lg border border-emerald-500/30"
                    >
                      Change Password
                    </button>
                  </div>
